(function(w, d){
    ...
    var styles = '<style>' +
        ...
        '@media (min-width:900px) and (max-width: 1024px){.xb_adaptive_container p:after{content: "@media (min-width:900px) and (max-width: 1024px)";}}'+
        '@media (min-width:0) and (max-width: 916px){.xb_adaptive_container p:after{content: "@media (min-width:0) and (max-width: 916px)";}}'+
        '@media (min-width:612px) and (max-width:916px){.xb_adaptive_container p:after{content: "@media (min-width:612px) and (max-width: 916px)";}}'+
        '@media (min-width: 0) and (max-width: 612px){.xb_adaptive_container p:after{content: "@media (min-width:0) and (max-width: 612px)";}}'+        
        '</style>';
    html += styles;
    ...
    w.onresize = function(event) {
        d.getElementById("wnwText").innerHTML =  "window size: "+document.documentElement.clientWidth+"px";
    };
