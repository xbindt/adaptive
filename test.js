...
'@media (min-width:900px) and (max-width: 1024px){.xb_adaptive_container h1:after{content: "(min-width:900px) and (max-width: 1024px)";}}'+
'@media (min-width:0) and (max-width: 916px){.xb_adaptive_container h1:after{content: "(min-width:0) and (max-width: 916px)";}}'+
'@media (min-width:612px) and (max-width:916px){.xb_adaptive_container h1:after{content: "(min-width:612px) and (max-width: 916px)";}}'+
'@media (min-width: 0) and (max-width: 612px){.xb_adaptive_container h1:after{content: "(min-width:0) and (max-width: 612px)";}}'+        
'</style>';
    html += styles;
